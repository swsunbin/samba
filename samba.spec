...
install -d -m 0755 %{buildroot}%{_sysconfdir}/persistent
install -d -m 0755 %{buildroot}%{_sysconfdir}/state
install -d -m 0755 %{buildroot}%{_sysconfdir}/volatile
install -m 0644 %{SOURCE100} %{buildroot}%{_sysconfdir}/ctdb/ctdb.conf
install -d -m 0755 %{buildroot}%{_sysconfdir}/ctdb/events/ctdb.conf
install -m 0755 ctdb/config/events/legacy/00.ctdb.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/00.ctdb.script
install -m 0755 ctdb/config/events/legacy/01.reclock.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/01.reclock.script
install -m 0755 ctdb/config/events/legacy/05.system.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/05.system.script
install -m 0755 ctdb/config/events/legacy/06.nfs.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/06.nfs.script
install -m 0755 ctdb/config/events/legacy/10.interface.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/10.interface.script
install -m 0755 ctdb/config/events/legacy/11.natgw.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/11.natgw.script
install -m 0755 ctdb/config/events/legacy/11.routing.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/11.routing.script
install -m 0755 ctdb/config/events/legacy/13.per_ip_routing.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/13.per_ip_routing.script
install -m 0755 ctdb/config/events/legacy/20.multipathd.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/20.multipathd.script
install -m 0755 ctdb/config/events/legacy/31.clamd.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/31.clamd.script
install -m 0755 ctdb/config/events/legacy/40.vsftpd.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/40.vsftpd.script
install -m 0755 ctdb/config/events/legacy/41.httpd.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/41.httpd.script
install -m 0755 ctdb/config/events/legacy/49.winbind.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/49.winbind.script
install -m 0755 ctdb/config/events/legacy/50.samba.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/50.samba.script
install -m 0755 ctdb/config/events/legacy/60.nfs.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/60.nfs.script
install -m 0755 ctdb/config/events/legacy/70.iscsi.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/70.iscsi.script
install -m 0755 ctdb/config/events/legacy/91.lvs.script %{buildroot}%{_sysconfdir}/ctdb/events/legacy/91.lvs.script
install -m 0644 %{SOURCE101} %{buildroot}%{_sysconfdir}/ctdb/script.options
install -m 0644 %{SOURCE102} %{buildroot}%{_sysconfdir}/ctdb/nodes
install -m 0644 %{SOURCE103} %{buildroot}%{_sysconfdir}/ctdb/public_addresses
...
%config(noreplace) %{_sysconfdir}/ctdb/public_addresses
...
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/00.ctdb.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/01.reclock.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/05.system.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/06.nfs.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/10.interface.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/11.natgw.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/11.routing.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/13.per_ip_routing.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/20.multipathd.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/31.clamd.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/40.vsftpd.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/41.httpd.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/49.winbind.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/50.samba.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/60.nfs.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/70.iscsi.script
%config(noreplace) %{_sysconfdir}/ctdb/events/legacy/91.lvs.script
