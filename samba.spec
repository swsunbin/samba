...
#
# 
# TIS - Always build with includelibs
...
# TIS compliance
%define samba_vendor tranquilit
%define samba_patch_revision 1

# TIS Update baserelease
%global baserelease 3
# This should be rc1 or %%nil
%global pre_release %nil
%define is_rc() %(LC_ALL="C" echo %{version} | grep -qi rc && echo 1 || echo 0)
...
# Tis - Patches
#Patch0001:      tis-sernet_acl_support_deny_aces.patch
...
BuildRequires: compat-gnutls37-devel >= 3.7.3
BuildRequires: compat-nettle37-devel >= 3.7.3
...
BuildRequires: python36-iso8601
#tis - BuildRequires: python3-pyasn1 >= 0.4.8
...
BuildRequires: python36-markdown
BuildRequires: python36-setproctitle
...
%prep
#tis - xzcat %{SOURCE0} | gpgv2 --quiet --keyring %{SOURCE2} %{SOURCE1} -
...
%configure \
        ...
        --with-relro \
        --without-fam \
        --vendor-name=%{samba_vendor} \
        --vendor-patch-revision=%{samba_patch_revision} \
...
%{python3_sitearch}/samba/tests/blackbox/__pycache__/http_chunk.cpython-*.pyc
%{python3_sitearch}/samba/tests/blackbox/__pycache__/http_content.cpython-*.pyc
...
%{_bindir}/ntlm_auth
%{_bindir}/wbinfo
#TIS %%{_libdir}/samba/krb5/winbind_krb5_localauth.so
%{_mandir}/man1/ntlm_auth.1.gz
%{_mandir}/man1/wbinfo.1*
#TIS %%{_mandir}/man8/winbind_krb5_localauth.8*
...
%changelog
* Wed Jan 31 2024 Yohannès ALEMU <yalemu-samba@tranquil.it> - 4.20.0rc1-2
- First Tranquil IT rpm release for 4.17
...
* Wed Sep 14 2022 Yohannès ALEMU <yalemu-samba@tranquil.it> - 4.17.0-2
- First Tranquil IT rpm release for 4.17
